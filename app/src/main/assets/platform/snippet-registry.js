(() => {
  ...
  const SNIPPETS = Object.freeze({
    javascript: Object.freeze({
      ...
      clg: 'console.log(${1});', cle: 'console.error(${1});',
      if: 'if (${1:condition}) {\n  ${2}\n}',
      ife: 'if (${1:condition}) {\n  ${2}\n} else {\n  ${3}\n}',
    ...
    jsx: Object.freeze({
      ...
      classname: 'className="${1}"', onCl: 'onClick={${1:(event) => ${2:handleClick}(event)}}'
    }),
    tsx: Object.freeze({
    ...
    python: Object.freeze({
      imp: 'import ${1:module}', from: 'from ${1:module} import ${2:name}',
      print: 'print(${1})', fn: 'def ${1:name}(${2}):\n    ${3}',
    ...
    kotlin: Object.freeze({
      ...
      println: 'println(${1})', if: 'if (${1:condition}) {\n    ${2}\n}',
      when: 'when (${1:value}) {\n    ${2}\n}'
    }),
    java: Object.freeze({
    ...
    ruby: Object.freeze({
      puts: 'puts ${1}', fn: 'def ${1:name}(${2})\n  ${3}\nend',
      each: '${1:items}.each do |${2:item}|\n  ${3}\nend',
      cls: 'class ${1:Name}\n  ${2}\nend'
    }),
    dart: Object.freeze({
      imp: "import '${1:package}';", void: 'void ${1:name}(${2}) {\n  ${3}\n}',
      main: 'void main() {\n  ${1}\n}', print: 'print(${1});',
      cls: 'class ${1:Name} {\n  ${2}\n}'
    }),
    swift: Object.freeze({
      import: 'import ${1:Foundation}',
      fn: 'func ${1:name}(${2}) -> ${3:Void} {\n    ${4}\n}',
      print: 'print(${1})', cls: 'class ${1:Name} {\n    ${2}\n}'
    }),
    shell: Object.freeze({
      shebang: '#!/usr/bin/env bash', echo: 'echo "${1}"',
    ...
    sql: Object.freeze({
      ...
      create: 'CREATE TABLE ${1:table} (\n  ${2:id INTEGER PRIMARY KEY}\n);'
    }),
    html: Object.freeze({
      doc: '<!doctype html>\n<html>\n<head>\n  <meta charset="UTF-8">\n  <title>${1:Document}</title>\n</head>\n<body>\n  ${2}\n</body>\n</html>',
      div: '<div>${1}</div>', button: '<button>${1}</button>', link: '<a href="${1:#}">${2}</a>'
    }),
    css: Object.freeze({
      rule: '${1:.selector} {\n  ${2:property}: ${3:value};\n}',
