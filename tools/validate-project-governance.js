...
for (const container of ['Data apk.zip','Informasi.zip','Skill.zip']) assert(registry.sourcePolicy.sourceContainers.includes(container), `missing source container in registry: ${container}`);
...
for (const source of ['Acode.zip','Acode screenshot.zip','Prompt.md','text.txt','Data apk.zip','Informasi.zip','Skill.zip']) {
